...
/* 
  direction control pins for Motor A
*/
int in1 = 8;           
int in2 = 7;
...
/*
 *  direction control pins for Motor B
 */
int in3 = 5;           
int in4 = 4;

// taking input from bluetooth in user_choice variable 
char user_choice;

void setup() {
  // All the motor control pins are set as output
  pinMode(in1, OUTPUT);
  pinMode(in2, OUTPUT);
  pinMode(in3, OUTPUT);
  pinMode(in4, OUTPUT);
  ...
  // The motors are turned off initially
